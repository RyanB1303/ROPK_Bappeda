...
class Kinerja extends CI_Controller
{
	...
	function simpan_perencanaan()
	{
		...
		//januari
		$jan_w1 = $this->input->post('jan_w1');
		$jan_w2 = $this->input->post('jan_w2');
		$jan_w3 = $this->input->post('jan_w3');
		$jan_w4 = $this->input->post('jan_w4');
		//februari
		$feb_w1 = $this->input->post('feb_w1');
		$feb_w2 = $this->input->post('feb_w2');
		$feb_w3 = $this->input->post('feb_w3');
		$feb_w4 = $this->input->post('feb_w4');
		//maret
		$mar_w1 = $this->input->post('mar_w1');
		$mar_w2 = $this->input->post('mar_w2');
		$mar_w3 = $this->input->post('mar_w3');
		$mar_w4 = $this->input->post('mar_w4');
		//april
		$apr_w1 = $this->input->post('apr_w1');
		$apr_w2 = $this->input->post('apr_w2');
		$apr_w3 = $this->input->post('apr_w3');
		$apr_w4 = $this->input->post('apr_w4');
		//mei
		$mei_w1 = $this->input->post('mei_w1');
		$mei_w2 = $this->input->post('mei_w2');
		$mei_w3 = $this->input->post('mei_w3');
		$mei_w4 = $this->input->post('mei_w4');
		//juni
		$jun_w1 = $this->input->post('jun_w1');
		$jun_w2 = $this->input->post('jun_w2');
		$jun_w3 = $this->input->post('jun_w3');
		$jun_w4 = $this->input->post('jun_w4');
		//juli
		$jul_w1 = $this->input->post('jul_w1');
		$jul_w2 = $this->input->post('jul_w2');
		$jul_w3 = $this->input->post('jul_w3');
		$jul_w4 = $this->input->post('jul_w4');
		//agustus
		$agt_w1 = $this->input->post('agt_w1');
		$agt_w2 = $this->input->post('agt_w2');
		$agt_w3 = $this->input->post('agt_w3');
		$agt_w4 = $this->input->post('agt_w4');
		//september
		$sep_w1 = $this->input->post('sep_w1');
		$sep_w2 = $this->input->post('sep_w2');
		$sep_w3 = $this->input->post('sep_w3');
		$sep_w4 = $this->input->post('sep_w4');
		//oktober
		$okt_w1 = $this->input->post('okt_w1');
		$okt_w2 = $this->input->post('okt_w2');
		$okt_w3 = $this->input->post('okt_w3');
		$okt_w4 = $this->input->post('okt_w4');
		//november
		$nov_w1 = $this->input->post('nov_w1');
		$nov_w2 = $this->input->post('nov_w2');
		$nov_w3 = $this->input->post('nov_w3');
		$nov_w4 = $this->input->post('nov_w4');
		//desember
		$des_w1 = $this->input->post('des_w1');
		$des_w2 = $this->input->post('des_w2');
		$des_w3 = $this->input->post('des_w3');
		$des_w4 = $this->input->post('des_w4');

		$data = array(
			"kode_perencanaan" => $kode_perencanaan,
			"nama_aktifitas" => $indikator,
